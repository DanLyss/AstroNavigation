...
from ..math1.converter_flat_hor import Star, Star_Cluster
from ..math2.latt_long_calc import mean_latitude, norm
    ...
    def test_lat_az(self):
        for idx, case in enumerate(self.test_cases):
            with self.subTest(f"Test Case #{idx + 1}"):
                ...
                computed_vals1 = np.array(mean_latitude(cluster)[:-1])
